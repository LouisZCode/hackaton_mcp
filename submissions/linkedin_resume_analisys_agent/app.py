    ...
    def enhance_image_for_linkedin(self) -> Tuple[gr.Row, gr.Image, gr.Image]:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Image conversion successful: {original_image.width}x{original_image.height}")
                ...
                try:
                    ...
                    if enhanced_image:
                        logger.info(f"Flux enhancement successful: {enhanced_image.width}x{enhanced_image.height}")
                    else:
                        logger.warning("Flux enhancement returned None, using original image")
                ...
                try:
                    ...
                    logger.info(f"LinkedIn optimization successful: {final_image.width}x{final_image.height}")
                ...
                logger.info("Image enhancement workflow completed successfully")
                
            except Exception as prep_error:
                logger.error(f"Image preparation failed: {prep_error}")
                raise prep_error
