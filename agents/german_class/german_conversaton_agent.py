...
def retrieve_student_profile(student_id, db_path="./dummy_student_data"):
    """
    Read and return a specific student profile based on ID.
    """
    ...
    # Process each file to find the requested student
